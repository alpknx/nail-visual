...
export default function DesignsPage() {
  ...
  const limit = 30; // Количество дизайнов за раз
    ...
    <>
      <div className="space-y-4">
        <div className="pt-16 md:pt-4">
          <h1 className="text-2xl font-semibold mb-2">{t('title') || 'Каталог дизайнов'}</h1>
          <p className="text-sm text-muted-foreground">
            {t('subtitle') || 'Найдите идеальный дизайн для ваших ногтей'}
          </p>
        </div>
